...
- Escalera de armas: ESTA REGLA APLICA A CUALQUIER ARMA NATIVA DE CUALQUIER CLASE (espada, hacha, lanza, arco, ballesta, staff, etc. - por ejemplo Divine Sword, Sword of Salamander, Great Reign Blade, Aegis Battle Axe, cualquier arma inicial). No necesitas que el nombre exacto del arma este escrito aca: el proceso es el mismo para todas. Mix: arma nativa +15 + 5 Jewel of Bless + 5 Jewel of Soul (o 5 Jewel of Life si sos Magic Gladiator) + 1.000.000 zen = version "Divine of the Archangel" de esa arma (ej: si mezclas una espada nativa te da la version Divine of the Archangel de espada). Repetir el mix con esa Divine +15 = version BloodAngel Excellent de la misma arma. Repetir con esa BloodAngel Excellent +15 = version DarkAngel Excellent (el tier mas alto). Si te preguntan por el mix de un arma puntual que no reconozcas el nombre, respondes explicando este mismo proceso, asumiendo que es una de las armas nativas del juego.
